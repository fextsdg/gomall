...
var (
	helloSeviceServiceInfo                = NewServiceInfo()
	helloSeviceServiceInfoForClient       = NewServiceInfoForClient()
	helloSeviceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return helloSeviceServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return helloSeviceServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return helloSeviceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "HelloSevice"
	handlerType := (*hello.HelloSevice)(nil)
...
func helloHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(hello.HelloSevice).Hello(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *HelloArgs:
		success, err := handler.(hello.HelloSevice).Hello(ctx, s.Req)
		if err != nil {
			return err
		}
