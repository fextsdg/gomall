...
type CreditInfo struct {
	...
	CreditExpirationYear int32  `protobuf:"varint,3,opt,name=credit_expiration_year,json=creditExpirationYear,proto3" json:"credit_expiration_year,omitempty"`
	CreditExpirationMoth int32  `protobuf:"varint,4,opt,name=credit_expiration_moth,json=creditExpirationMoth,proto3" json:"credit_expiration_moth,omitempty"`
}
...
func (x *CreditInfo) GetCreditCardNumber() string {
	if x != nil {
...
func (x *CreditInfo) GetCreditCardCvv() int32 {
	if x != nil {
...
func (x *CreditInfo) GetCreditExpirationYear() int32 {
	if x != nil {
		return x.CreditExpirationYear
	}
	return 0
}

func (x *CreditInfo) GetCreditExpirationMoth() int32 {
	if x != nil {
		return x.CreditExpirationMoth
	}
	return 0
}
...
type ChargeReq struct {
	...
	CreditInfo *CreditInfo `protobuf:"bytes,3,opt,name=credit_info,json=creditInfo,proto3" json:"credit_info,omitempty"`
	Amount     float32     `protobuf:"fixed32,4,opt,name=amount,proto3" json:"amount,omitempty"` //交易总价
}
...
func (x *ChargeReq) GetCreditInfo() *CreditInfo {
	if x != nil {
		return x.CreditInfo
	}
	return nil
...
var file_payment_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xce, 0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x2c, 0x0a, 0x12, 0x63, 0x72, 0x65, 0x64, 0x69,
	...
	,
	...
	0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x0b, 0x63,
	0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x69,
	...
	0x02, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x33, 0x0a, 0x0a, 0x43, 0x68, 0x61,
	...
	0x65, 0x73, 0x70, 0x42, 0x22, 0x5a, 0x20, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70,
...
var file_payment_proto_goTypes = []interface{}{
	(*CreditInfo)(nil), // 0: payment.CreditInfo
	(*ChargeReq)(nil),  // 1: payment.ChargeReq
	(*ChargeResp)(nil), // 2: payment.ChargeResp
}
var file_payment_proto_depIdxs = []int32{
	0, // 0: payment.ChargeReq.credit_info:type_name -> payment.CreditInfo
