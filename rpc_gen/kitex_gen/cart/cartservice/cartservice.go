...
func addCartHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(cart.AddCartReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(cart.CartService).AddCart(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *AddCartArgs:
		success, err := handler.(cart.CartService).AddCart(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*AddCartResult)
...
func newAddCartArgs() interface{} {
	return &AddCartArgs{}
}

func newAddCartResult() interface{} {
	return &AddCartResult{}
}

type AddCartArgs struct {
	Req *cart.AddCartReq
}

func (p *AddCartArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(cart.AddCartReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *AddCartArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
...
func (p *AddCartArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
...
func (p *AddCartArgs) Unmarshal(in []byte) error {
	msg := new(cart.AddCartReq)
...
var AddCartArgs_Req_DEFAULT *cart.AddCartReq

func (p *AddCartArgs) GetReq() *cart.AddCartReq {
	if !p.IsSetReq() {
		return AddCartArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *AddCartArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *AddCartArgs) GetFirstArgument() interface{} {
	return p.Req
}

type AddCartResult struct {
	Success *cart.AddCartResp
}

var AddCartResult_Success_DEFAULT *cart.AddCartResp

func (p *AddCartResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(cart.AddCartResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *AddCartResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
...
func (p *AddCartResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
...
func (p *AddCartResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
...
func (p *AddCartResult) Unmarshal(in []byte) error {
	msg := new(cart.AddCartResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *AddCartResult) GetSuccess() *cart.AddCartResp {
	if !p.IsSetSuccess() {
		return AddCartResult_Success_DEFAULT
	}
	return p.Success
}

func (p *AddCartResult) SetSuccess(x interface{}) {
	p.Success = x.(*cart.AddCartResp)
}

func (p *AddCartResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AddCartResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) AddCart(ctx context.Context, Req *cart.AddCartReq) (r *cart.AddCartResp, err error) {
	var _args AddCartArgs
	_args.Req = Req
	var _result AddCartResult
	if err = p.c.Call(ctx, "AddCart", &_args, &_result); err != nil {
		return
	}
