...
func (x *AddCartReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_AddCartReq[number], err)
}

func (x *AddCartReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *AddCartReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	var v CartItem
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *AddCartResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	default:
		offset, err = fastpb.Skip(buf, _type, number)
		if err != nil {
...
func (x *CartItem) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 2, x.GetNum())
	return offset
}
...
func (x *AddCartReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *AddCartReq) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 1, x.GetUserId())
...
func (x *AddCartReq) fastWriteField2(buf []byte) (offset int) {
	if x.Item == nil {
		return offset
	}
...
func (x *AddCartResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	return offset
...
func (x *CartItem) sizeField2() (n int) {
	...
	n += fastpb.SizeUint32(2, x.GetNum())
	return n
}
...
func (x *AddCartReq) sizeField1() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeUint32(1, x.GetUserId())
...
func (x *AddCartReq) sizeField2() (n int) {
	if x.Item == nil {
		return n
	}
...
var fieldIDToName_AddCartReq = map[int32]string{
	1: "UserId",
	2: "Item",
}

var fieldIDToName_AddCartResp = map[int32]string{}
