...
func (x *AddCartReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AddCartReq) GetItem() *CartItem {
	if x != nil {
		return x.Item
	}
	return nil
...
var file_cart_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x22, 0x3b, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x1d,
	0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x12, 0x10, 0x0a,
	...
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x49, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x43, 0x61, 0x72,
	...
	0x04, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x63, 0x61,
	0x72, 0x74, 0x2e, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x04, 0x69, 0x74, 0x65,
	0x6d, 0x22, 0x0d, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x12, 0x30, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x43, 0x61, 0x72, 0x74, 0x12, 0x10, 0x2e, 0x63, 0x61,
	0x72, 0x74, 0x2e, 0x41, 0x64, 0x64, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x11, 0x2e,
	...
	0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x1f, 0x5a, 0x1d,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*AddCartReq)(nil),    // 2: cart.AddCartReq
	(*AddCartResp)(nil),   // 3: cart.AddCartResp
...
var file_cart_proto_depIdxs = []int32{
	...
	0, // 1: cart.AddCartReq.item:type_name -> cart.CartItem
	1, // 2: cart.GetCartResp.cart:type_name -> cart.Cart
	2, // 3: cart.CartService.AddCart:input_type -> cart.AddCartReq
	4, // 4: cart.CartService.GetCart:input_type -> cart.GetCartReq
	6, // 5: cart.CartService.EmptyCart:input_type -> cart.EmptyCartReq
	3, // 6: cart.CartService.AddCart:output_type -> cart.AddCartResp
...
type CartService interface {
	AddCart(ctx context.Context, req *AddCartReq) (res *AddCartResp, err error)
